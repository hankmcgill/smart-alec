  ...
  return (
    <form onSubmit={handleSubmit} className="mb-8 border-b border-gray-200 dark:border-gray-700 pb-6">
      ...
      <button
        type="submit"
        disabled={submitting}
        className="bg-emerald-600 hover:bg-emerald-500 text-white font-medium px-6 py-2.5 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      >
